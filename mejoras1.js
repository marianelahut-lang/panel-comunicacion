/* ============================================================
   ...
   v2.7 · Agenda publicaciones + gacetilla masiva
   ------------------------------------------------------------
...
(function(){
  ...
  function cargarContactosMedios(){
    try {
      ...
      // Si HAY algo guardado (aunque sea []), respetarlo. Solo inicializar
      // si NUNCA se guardó (raw === null).
      if(raw !== null){
        var parsed = JSON.parse(raw);
        if(Array.isArray(parsed)) return parsed;
      }
  ...
  function init(){
    ...
    try {
      console.log("%c[mejoras1.js v2.7] agenda publicaciones + gacetilla masiva",
